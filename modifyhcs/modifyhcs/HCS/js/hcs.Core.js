...
hcs.Core = function () {
    ...
    var n = null, i = 640, o = 480, r = 260, s = 260, a = 1, l = null, h = null, c = {}, u = hcs.Constants.MODE_STANDALONE, p = null, d = null, m = null, g = null, f = !1, y = null, v = !1, b = null, w = "2D", x = null, C = function (e, _, v) {
        if (this.version = e, this.isFullyInitialized = !1, window.hcsdesign = this, this.ENGINE_2D = 1, this.ENGINE_3D = 2, this.MODE_EDITOR = 1, this.MODE_VIEWER = 2, this.LOCAL_STORAGE_STRUCTURE_KEY = "wanadev.planner.structure", this.i18n = _, /*hcs.UI.LanguageSelector.setLocal(_.getLocale().split("_")[0]),*/ l = document.getElementById("container2d"), h = document.getElementById("container3d"), a = this.ENGINE_2D, c = { structure: [], limit: 50, cursor: 0, getLatest: function () {
            ...
            var C = b.env || "";
            hcs.Constants.PRODUCTS_CATEGORY_FILE = [hcs.Constants.WNP_URL, "data/", p, "/categories" + C + ".json"].join(""), 
			hcs.Constants.TEXTURES_FILE = [hcs.Constants.WNP_URL, "data/", p, "/textures" + C + ".json"].join(""), 
    ...
    return C.prototype.initialize = function (t) {
        ...
        if (e = window.MSPointerEvent ? "MSPointerUp" : e, this.engine2D.getContainer().addEventListener(e, this.saveHistory.bind(this), !1), this.engine3D.getContainer().addEventListener(e, this.saveHistory.bind(this), !1), document.addEventListener("hcs.request.saveHistory", this.saveHistory.bind(this), !1), document.addEventListener("hcs.request.switchEngine", this.switchEngine.bind(this), !1), document.addEventListener("hcs.request.changeEngine", function (e) {
            ...
            n === !1 && (this._clearLocaleStructure(), this._createDefaultStructure(), ujs.notify("hcs.core.structure.loaded")), this.engine2D.bestZoom(), this.hideSplashScreen()
        } else
        ...
        if (o = r == n.ENGINE_2D ? l.children[0] : h.children[0], u == hcs.Constants.MODE_STANDALONE || null === y) {
            ...
            var d = function (t) {
                ujs.ajax({ method: "POST", withCredentials: !0, url: y, params: t.join(""), error: i, success: function (t) {
                    ...
                    if ("ok" === o.status)
                        r = _("Your screenshot has been saved."), n.structure.planId = !0, hcs.UI.MessageBox.show({ title: _("Screenshot"), message: r, buttonAText: _("Close"), buttonA: !0, autoHide: !0, force: !0 }), o.params && (b = o.params), hcs.UI.MessageBox.show(s), e();
                    else {
                        if (o.connectionUrl)
        ...
        if (this.mode == this.MODE_VIEWER)
            return null;
        var t = "undefined" != typeof t ? t : !1, i = n.structure.serialize(), o = hcsLocalStorage.getItem(n.LOCAL_STORAGE_STRUCTURE_KEY);
        return o !== i || e ? (n.removeLocalStructure(!1), hcsLocalStorage.setItem(n.LOCAL_STORAGE_STRUCTURE_KEY, i), t && hcs.UI.MessageBox.show({ title: _("Save a Plan"), message: _("Your plan has been saved."), buttonAText: _("Close"), button: !0 }), i) : null
    }, C.prototype.loadLocalStructure = function (t) {
        var t = "undefined" != typeof t ? t : !1, e = hcsLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY), n = this;
        if (null != e) {
            var i = n.lock();
            return n.structure.deserialize(e) ? (n.structure.setCurrentStructureIndex(0), n.updateDeserialisation(i)) : (this.removeLocalStructure(!1), t && hcs.UI.MessageBox.show({ title: _("Load a Plan"), message: _("Unable to load your plan: its version is too old."), buttonAText: _("Close"), buttonA: !0 })), t && hcs.UI.MessageBox.show({ title: _("Load a Plan"), message: _("Your plan has been loaded."), buttonAText: _("Close"), buttonA: !0 }), ujs.notify("hcs.structure.locale.loaded"), !0
        }
        return t && hcs.UI.MessageBox.show({ title: _("Load a Plan"), message: _("You have no saved plan."), buttonAText: _("Close"), buttonA: !0 }), !1
    }, C.prototype.removeLocalStructure = function (t) {
        var t = "undefined" != typeof t ? t : !1, e = hcsLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY);
        return null != e ? (hcsLocalStorage.removeItem(this.LOCAL_STORAGE_STRUCTURE_KEY), t && hcs.UI.MessageBox.show({ title: _("Remove a Plan"), message: _("Your plan has been removed."), buttonAText: _("Close"), button: !0 }), !0) : !1
        ...
        var e = e || function () {
            ...
            ujs.ajax({ url: hcs.Constants.BACK_URL + hcs.Constants.MIGRATION_PATH + t, withCredentials: !0, success: function (t) {
                t ? i(t) : e(-1)
            } 
            })
        };
        ...
        return void 0 != hcsLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY) ? !0 : !1
        ...
        hcs.UI.IFrame.show(document.body, { width: e, height: n, src: t }, { showClose: !0 })
    }, C
} ();
