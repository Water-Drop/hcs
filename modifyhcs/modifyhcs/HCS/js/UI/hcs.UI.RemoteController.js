/*
 * Author: Zhou Jun
 * Function: 控制remote controller组件，包括初始化、显示、关闭、设置显示位置
 */
var hcs = window.hcs || {};
hcs.UI = hcs.UI || {}, hcs.UI.RemoteController = function() {
    var t, e = document.getElementById("modalWidgets"), remotecontroller = function(remotecontroller, i) {
        function operate() {
            if (++l > t.repeat) {
                if (l = 0, null != t.buttonState) {
                    var e = t.buttonState, n = e.target.getAttribute("class");
                    null == remotecontroller && (n = e.target.parentNode.getAttribute("class"));
                    var i = remotecontroller.split(" ")[1];
                    switch (i) {
                        case "up":
                            t.setDirection(i);
                            break;
        ...
        var remotecontroller = remotecontroller || {}, i = i || {};
        ...
        }}, operate(), this.buttonState = null, this.running = !0, this.repeat = 3;
        var l = 0;
        operate()
    };
    return remotecontroller.prototype.buildHTML = function() {
    ...
    }, remotecontroller.prototype.onKeyDown = function(e) {
        var n = e.keyCode;
        switch (n) {
            case 37:
                t.setDirection("left");
    ...
    }, remotecontroller.prototype.updateDomPosition = function(t, e) {
        this.defaultDomStyle = "top: " + e + "px;left: " + t + "px;", this.domElement.setAttribute("style", this.defaultDomStyle)
    }, remotecontroller.prototype.kill = function(t) {
    ...
    }, remotecontroller.prototype.onButtonMouseDown = function(t, e) {
        e.buttonState = t
    }, remotecontroller.prototype.onButtonMouseUp = function(t, e) {
        e.buttonState = null
    }, remotecontroller.prototype.onButtonClick = function(t, e) {
