...
hcs.MaterialFactory = function() {
    ...
    return t.prototype.mergeParams = function(t, e) {
        ...
        return t.uScale = e, t.vSca
		le = n, t
    }, t.MakeBasicMaterial = function(t) {
        t.ambientColor.copyFromFloats(.6, .6, .6), 
		t.diffuseColor.copyFromFloats(0, 0, 0), 
		t.specularColor.copyFromFloats(0, 0, 0), 
		t.emissiveColor.copyFromFloats(.05, .05, .05)
    }, t.MakeBasicColor = function(t, e) {
        t.ambientColor.copyFromFloats(0, 0, 0), 
		t.specularColor.copyFromFloats(0, 0, 0), 
		t.diffuseColor.copyFromFloats(0, 0, 0), 
		t.emissiveColor.copyFrom(e)
        ...
        o ? o = new o(e.name || "ImportedMaterial", hcs.engine3D.scene) : (o = new BABYLON.StandardMaterial(e.name || "ImportedMaterial", hcs.engine3D.scene), this.MakeDefaultMaterial(o)), e.color && (o.diffuseColor.copyFrom(e.color), o.params.baseColor = e.color);
        for (var r in e)
            void 0 !== o[r] && null !== o[r] ? e[r] instanceof Array && o[r].fromArray ? o[r].fromArray(e[r]) : e[r] instanceof Object && o[r].copyFrom ? o[r].copyFrom(e[r]) : -1 !== r.indexOf("Texture") ? (o[r] = new BABYLON.Texture(e[r], hcs.engine3D.scene), o[r].vScale = e.vScale || e.scale || 1, o[r].uScale = e.uScale || e.scale || 1, o[r].hasAlpha = e.hasAlpha || !1) : o[r] = e[r] : -1 !== r.indexOf("Texture") ? (o[r] = new BABYLON.Texture(e[r], hcs.engine3D.scene), o[r].vScale = e.vScale || e.scale || 1, o[r].uScale = e.uScale || e.scale || 1) : o[r] = e[r];
        if ((-1 != n.indexOf("Glass") || -1 != n.indexOf("Transparent") || -1 != n.indexOf("Metal")) && e.addColor && e.addColor.color)
            ...
            var l = new BABYLON.DynamicTexture("canvas", e.addColor.size.width, hcs.engine3D.scene, !0);
