...
hcs.UI = hcs.UI || {}, hcs.UI.FormBuilder = function() {
    ...
    return i.prototype.updateProperties = function(t) {
        ...
        var u = "";
        if ("range" == r && (u += " input-range"), s && (u += " unit"), "" != u && c.setAttribute("class", u), "range" == r && c.addEventListener("input", this.onItemAction, !1), c.addEventListener("change", this.onItemAction, !1), c.addEventListener("keydown", function(t) {t.stopPropagation()
