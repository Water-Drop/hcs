...
hcs.Core = function() {
    function t() {
        var t = n.mode == n.MODE_EDITOR ?
                r :
                0;
        n.setSize(window.innerWidth - t, window.innerHeight)
    }
    function e(t, e) {
        return t.uuid || (t.uuid = wnp.uuid.uuid4()), t.lastModified || "wnpLocalStorage" == e ?
                t.lastModified || (t.lastModified = 0) :
                t.lastModified = (new Date).getTime(), t
    }
    var n = null, i = 640, o = 480, r = 260, s = 260, a = 1, l = null, h = null, c = {}, u = hcs.Constants.MODE_STANDALONE, p = null, d = null, m = null, g = null, f = false, y = null, v = false, b = null, w = "2D", x = null, C = function(e, _, v) {
        this.version = e, this.isFullyInitialized = false, window.wanaplan = this, this.ENGINE_2D = 1, this.ENGINE_3D = 2, this.MODE_EDITOR = 1, this.MODE_VIEWER = 2, this.LOCAL_STORAGE_STRUCTURE_KEY = "wanadev.planner.structure", this.i18n = _, wnp.UI.LanguageSelector.setLocal(_.getLocale().split("_")[0]), l = document.getElementById("container2d"), h = document.getElementById("container3d"), a = this.ENGINE_2D, c = {structure: [], limit: 50, cursor: 0, getLatest: function() {
                return this.structure[this.cursor]
            }}, v.css && HTMLHelper.addStylesheet(v.css), this.allow3D = "undefined" != typeof v.allow3D ?
                v.allow3D :
                true, this.api = v || {}, d = this.api.saveUrl || null, m = this.api.newUrl || null, g = this.api.planUrl || null, y = this.api.screenshotUrl || null, f = this.api.publisher || false, _origin = this.api.origin || false, this.mode = "true" === this.api.isViewer ?
                this.MODE_VIEWER :
                this.MODE_EDITOR, this.api.params = this.api.params ?
                JSON.parse(this.api.params) :
                {}, this.api.id > 0 && (p = this.api.id, u = wnp.Constants.MODE_CUSTOMER, b = this.api.params, w = this.api.screenshotMode || "2D", x = this.api.title || null, wnp.Constants.PRODUCTS_CATEGORY_FILE = [wnp.Constants.WNP_URL, "/data/", p, "/categories.json"].join(""), wnp.Constants.TEXTURES_FILE = [wnp.Constants.WNP_URL, "/data/", p, "/textures.json"].join(""), wnp.Constants.PRODUCTS_FILE = [wnp.Constants.WNP_URL, "/data/", p, "/products.json"].join(""), wnp.Constants.PRODUCTS_PREVIEWS = [wnp.Constants.WNP_URL, "/data/previews/"].join("")), i = window.innerWidth, o = window.innerHeight, this.needPageRefresh = false, this.loopTimer = new wnp.LoopTimer, this.structure = new wnp.Structure(e), this.keyboardManager = new wnp.KeyboardManager, this.configuration = new wnp.Configuration, this.engine2D = new wnp.Engine2D(l, this), this.engine3D = null, this.engine3D = GlobalHelper.hasWebGL() ?
                new wnp.Engine3D(h) :
                new wnp.Dummy.Engine3D(h), this.aboutWindow = null;
        var C = this;
        n = this, window.addEventListener("resize", t, false);
        var M = false;
        if (document.addEventListener("keydown", function(t) {
            C.getSelectedEngine() === C.ENGINE_2D && ((t.ctrlKey || M) && 90 == t.keyCode ?
                    n.backFromHistory() :
                    (t.ctrlKey || n.pomme) && 89 == t.keyCode && n.nextFromHistory(), M = 91 == t.keyCode ?
                    true :
                    M)
    ...
    return C.prototype.initialize = function(t) {
        this.mode == this.MODE_VIEWER ?
                ...
                this.initializeEditor(t), setTimeout(function() {
        ...
        }, GlobalHelper.hasWebGL() ?
                (n.setAttribute("title", _("Switch the view to 2D or 3D")), n.addEventListener("click", function() {
                    e.switchEngine(), e.changeToggleEngineLabel("2D" == n.children[0].innerHTML ?
                            "3D" :
                            "2D")
                }, false)) :
                n.style.display = "none", this.changeToggleEngineLabel(+this.api.startOn2D ?
                        "3D" :
                        "2D"), this._createDefaultStructure(), this.menu = {addMenuItem: function() {
            }}, this.helpBubbleManager = {alreadyDisplayed: function() {
            }, display: function() {
            }}, this.engine2D.isViewer = true, this.engine3D.isViewer = true, this.engine2D.initialize(), this.engine3D.initialize(), g ?
                this._getStructureFromUrl(g, function(e) {
                    this._loadStructure(e), this.engine2D.bestZoom(), this.hideSplashScreen(), t.call(this)
                }.bind(this)) :
                this._localStructureExists() ?
                this._loadStructure(this._getLocaleStorageStructure(), t) :
                t(this)
        ...
        if (e = window.MSPointerEvent ?
            ...
            g ?
                    this._getStructureFromUrl(g, function(t) {
                        if (!t)
        ...
        var n = t == this.ENGINE_3D || "3D" == t, i = this.engine2D.isEnabled() ?
                "2D" :
                "3D", o = n ?
                "3D" :
                "2D";
        this.engine2D.setEnabled(!n), this.engine3D.setEnabled(n), a = "3D" == t || t == this.ENGINE_3D ?
                this.ENGINE_3D :
                this.ENGINE_2D, ujs.notify("wnp.contextChanged", {context: o, previousContext: i}), this.helpBubbleManager && this.helpBubbleManager.helpBubble && this.helpBubbleManager.helpBubble.hide()
        ...
        var o, r = "undefined" != typeof t.selectedEngine ?
                t.selectedEngine :
                a, s = "undefined" != typeof t.sendBlob ?
                t.sendBlob :
                false, e = e || function() {
                }, i = i || function() {
        };
        if (o = r == n.ENGINE_2D ?
                l.children[0] :
                h.children[0], u == wnp.Constants.MODE_STANDALONE || null === y) {
            if (e(), s)
            ...
            var d = function(t) {
                ujs.ajax({method: "POST", withCredentials: true, url: y, params: t.join(""), error: i, success: function(t) {
                        ...
                        if ("ok" === o.status)
                            ...
                            if (o.connectionUrl)
                                ...
                                var s = {title: _("Screenshot"), message: o.message || _("Error occured during save."), buttonA: true, buttonAText: _("Ok"), onClickA: function() {
            ...
            r === n.ENGINE_2D ?
                    (c.push("screenshot=" + o.toDataURL("image/png")), d(c)) :
                    GlobalHelper.createScreenshot3D(n.engine3D.engine, void 0, function(t) {
        ...
        this.setSelectedEngine(a == this.ENGINE_2D ?
                this.ENGINE_3D :
                this.ENGINE_2D)
    }, C.prototype.getComponentByName = function(t, e) {
        var e = void 0 != typeof e ?
                e :
                3;
        if (e == this.ENGINE_2D)
        ...
        if (this.mode == this.MODE_VIEWER)
            return null;
        var t = "undefined" != typeof t ?
                t :
                false, i = n.structure.serialize(), o = wnpLocalStorage.getItem(n.LOCAL_STORAGE_STRUCTURE_KEY);
        return o !== i || e ?
                (n.removeLocalStructure(!1), wnpLocalStorage.setItem(n.LOCAL_STORAGE_STRUCTURE_KEY, i), t && wnp.UI.MessageBox.show({title: _("Save a Plan"), message: _("Your plan has been saved."), buttonAText: _("Close"), button: true}), i) :
                null
    }, C.prototype.loadLocalStructure = function(t) {
        var t = "undefined" != typeof t ?
                t :
                false, e = wnpLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY), n = this;
        if (null != e) {
            var i = n.lock();
            return n.structure.deserialize(e) ?
                    (n.structure.setCurrentStructureIndex(0), n.updateDeserialisation(i)) :
                    (this.removeLocalStructure(!1), t && wnp.UI.MessageBox.show({title: _("Load a Plan"), message: _("Unable to load your plan: its version is too old."), buttonAText: _("Close"), buttonA: true})), t && wnp.UI.MessageBox.show({title: _("Load a Plan"), message: _("Your plan has been loaded."), buttonAText: _("Close"), buttonA: true}), ujs.notify("wnp.structure.locale.loaded"), true
        }
        ...
        var t = "undefined" != typeof t ?
                t :
                false, e = wnpLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY);
        return null != e ?
                (wnpLocalStorage.removeItem(this.LOCAL_STORAGE_STRUCTURE_KEY), t && wnp.UI.MessageBox.show({title: _("Remove a Plan"), message: _("Your plan has been removed."), buttonAText: _("Close"), button: true}), true) :
                false
    }, C.prototype.getPreviewImage = function(t, e) {
        var i = null, o = null, r = n.engine2D.getZoom(), s = n.engine2D.getTranslation();
        n.setSize(t, e), this.getSelectedEngine() == this.ENGINE_2D ?
                (n.engine2D.bestZoom(), n.engine2D.draw(), o = n.engine2D.canvas) :
                (o = n.getContainer3D().getElementsByTagName("canvas")[0], n.engine3D.draw()), i = o.toDataURL("image/png");
        var a = n.mode == n.MODE_EDITOR ?
                260 :
                0;
        ...
        var e = e || function() {
            ...
            ujs.ajax({url: wnp.Constants.BACK_URL + wnp.Constants.MIGRATION_PATH + t, withCredentials: true, success: function(t) {
                    t ?
                            i(t) :
                            e(-1)
                }})
        ...
        g ?
                (ujs.ajax({url: g, withCredentials: true, success: function(t) {
                        if (t) {
                            var n = JSON.parse(t);
                            1 == wanaplan.compareVersion(wnp.Constants.VERSION, n.version) ?
                                    i(t) :
                                    (console.log("migration"), o(g))
                        } else
                            e(-1)
                    }}), g = null) :
                e(-2)
        ...
        this.getHistory().cursor <= 0 ?
                this.getHistory().cursor = 0 :
                this.getHistory().cursor--;
        ...
        return void 0 != wnpLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY) ?
                true :
                false
    }, C.prototype._getLocaleStorageStructure = function() {
        return this._localStructureExists() ?
                e(JSON.parse(wnpLocalStorage.getItem(this.LOCAL_STORAGE_STRUCTURE_KEY)), "wnpLocalStorage") :
                null
        ...
        var i = function(i) {
            if (i) {
                var r = JSON.parse(i);
                1 == wanaplan.compareVersion(wnp.Constants.VERSION, r.version) ?
                        o(t, n) :
                        n(e(r))
            } else
                n(null)
        ...
        ujs.ajax({url: t, withCredentials: true, success: i, onerror: function() {
                r(t, n)
            }})
        ...
        this.structure.deserialize("string" == typeof t ?
                t :
                JSON.stringify(t)), ujs.notify("wnp.core.structure.loaded");
        var e = e || function() {
        };
