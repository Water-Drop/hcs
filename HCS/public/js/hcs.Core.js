...
wnp.Core = function () {
	...
	return C.prototype.initialize = function (t) {
		...
		return localStructure !== currentStructure || e ? (wnpLocalStorage.setItem(n.LOCAL_STORAGE_STRUCTURE_KEY, currentStructure), t && wnp.UI.MessageBox.show({ title: _("保存设计"), message: _("你的设计已经保存成功."), buttonAText: _("关闭"), button: true }), currentStructure) : null
