...
socket.emit('init', { uuid: 'bae9e1d5-47ca-4fc2-af27-0e27da13de65' }, function (data) {
    ...
    function e() {
        d = {
            ...
            height: "146", 
            id: "1", 
            origin: "http://www.hcsdesign.com", 
            params: "{}",
            width: "1277"
        }
        if (!GlobalHelper.hasWebGL() && e && (d.allow3D = false),
                hcsdesign = new l.Core(h, c, d), 
                hcsdesign.engine2D.addComponent(GridComponent2D), 
                hcsdesign.engine2D.addComponent(PointComponent2D), 
                hcsdesign.engine2D.addComponent(WallComponent2D), 
                hcsdesign.engine2D.addComponent(RoomComponent2D), 
                /* hcsdesign.engine2D.addComponent(StairwayComponent2D), 
                 * hcsdesign.engine2D.addComponent(HopperComponent2D),*/ 
                hcsdesign.engine2D.addComponent(SubSlopeComponent2D), 
                hcsdesign.engine2D.addComponent(SubSlopeOvertureComponent2D), 
                hcsdesign.engine2D.addComponent(OvertureComponent2D), 
                hcsdesign.engine2D.addComponent(MobileComponent), 
                hcsdesign.engine2D.addComponent(MobileInputComponent), 
                /*hcsdesign.engine2D.addComponent(AnalyticsComponent), 
                 * hcsdesign.engine2D.addComponent(FloorController),*/ 
                hcsdesign.engine2D.addComponent(MeasureComponent), 
                hcsdesign.engine3D.addComponent(CameraComponent), 
                hcsdesign.engine3D.addComponent(GridComponent3D), 
                hcsdesign.engine3D.addComponent(AvatarComponent3D), 
                hcsdesign.engine3D.addComponent(RoomComponent3D), 
                hcsdesign.engine3D.addComponent(OvertureComponent3D), 
                hcsdesign.engine3D.addComponent(SubSlopeComponent3D), 
                hcsdesign.engine3D.addComponent(WallComponent3D), 
                hcsdesign.engine3D.addComponent(StairwayComponent3D), 
                hcsdesign.engine3D.addComponent(HopperComponent3D), 
                hcsdesign.engine3D.addComponent(ObjectComponent3D), 
                hcsdesign.engine3D.addComponent(FloorComponent3D), 
                hcsdesign.engine3D.addComponent(RemoteControlComponent3D), 
                hcsdesign.engine3D.addComponent(TransparencyComponent), 
                r(), 
                o(d), 
                hcsdesign.setSelectedEngine(hcsdesign.ENGINE_2D), 
                hcsdesign.mode == hcsdesign.MODE_VIEWER
            ) {
