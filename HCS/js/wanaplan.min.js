...
wnp.Core = function() {
    ...
    return C.prototype.initialize = function(t) {
        // function() {this.engie2D.bestZoom()}.bind(this) this对应的实例对象传入
...
var BaseStructure = function() {
    ...
    var t = [{title: "Draw",index: 1,icon: "http://v2.wanaplan.fr/images/dessiner.png",action: "wnp.request.changeEngine",id: "draw2D",params: {engine: "2D"},layout: "layout-list",context: "2D",items: []}, {title: "Furnish",index: 2,icon: "http://v2.wanaplan.fr/images/meubler.png",action: "wnp.request.changeEngine",id: "furnishing3D",context: "3D",params: {engine: "3D"},layout: "layout-list",items: []}, {title: "Decorate",index: 3,icon: "http://v2.wanaplan.fr/images/decorer.png",action: "wnp.request.changeEngine",id: "decorate3D",context: "3D",params: {engine: "3D"},layout: "layout-list",items: []}], e = function(e) {
    ...
    var t, e = !1, n = function(e) {
        BaseTopMenuComponent2D.call(this, e, "SaveComponent"), this._item = {title: "Save",icon: "http://v2.wanaplan.fr/images/save_icon.png",action: "wnp.request.saveStructure",id: "toolbarSave",items: [],index: "2"}, document.addEventListener("wnp.request.saveStructure", this.saveStructure.bind(this), !1), window.addEventListener("message", function(e) {
    ...
    return n.prototype = Object.create(BaseTopMenuComponent2D.prototype), n.prototype.startProcess = function() {
        ...
        t.core.api.id && l.push("&id=" + t.core.api.id), t.core.api.apiKey && l.push("&apikey=" + t.core.api.apiKey), n && l.push("&description=" + encodeURIComponent(n)), ujs.ajax({method: "POST",url: t.core.api.saveUrl,withCredentials: !0,params: l.join(""),onerror: function(e) {
                                                                                                                                                                                     t.onError(e), o && o()
                                                                                                                                                                                     },success: function(e) {
...
}(), TransparencyComponent = function() {
    var t = 0, e = t, n = function(t) {
        BaseComponent3D.call(this, t, "TransparencyComponent"), this._item = {title: _("Transparency"),id: "transparencyButton",icon: "http://v2.wanaplan.fr/images/icon-transparency.png",action: "wnp.request.switch-transparency",addClass: "hidden",index: 12}
    };
    return n.prototype = Object.create(BaseComponent3D.prototype), n.prototype.initialize = function() {
        BaseComponent3D.prototype.initialize.call(this), ujs.notify("wnp.menu.top.sub.add", {item: this._item,menuPath: "."})
        ...
        BaseComponent3D.prototype.onContextChanged.call(this, t), "3D" == t ? ujs.notify("wnp.menu.top.sub.replace", {item: {id: "transparencyButton",addClass: ""},merge: !0}, !0) : ujs.notify("wnp.menu.top.sub.replace", {item: {id: "transparencyButton",addClass: "hidden"},merge: !0}, !0)
    }, n.prototype.onWallTransparencyOn = function() {
        var t = wanaplan.getComponentByName("TopMenuComponent");
        if (t) {
            var e = t.submenu;
            e.replaceMenuItem("transparencyButton", {icon: "http://v2.wanaplan.fr/images/icon-opacity.png"}, !0), e.updateHtml()
        }
    }, n.prototype.onWallTransparencyOff = function() {
        var t = wanaplan.getComponentByName("TopMenuComponent");
        if (t) {
            var e = t.submenu;
            e.replaceMenuItem("transparencyButton", {icon: "http://v2.wanaplan.fr/images/icon-transparency.png"}, !0), e.updateHtml()
        }
    ...
    return t.prototype = new BaseComponent2D, t.prototype.startListening = function() {
        ...
        var t = {id: "gridBackgroundMenu",title: _("添加背景"),action: "wnp.engine2d.onAddBackground",cancelAction: "wnp.engine2d.onEndBackground"};
    ...
    var t = function(t) {
        BaseComponent3D.call(this, t, "HistoryEditionComponent"), this.historyComponent3D = null, this.isMainMenuItem = !1, this._items = [{title: _("Undo"),icon: "fa fa-reply",action: "wnp.request.undo",index: 10}, {title: _("Redo"),icon: "fa fa-share",action: "wnp.request.redo",index: 11}], this.undo = this.undo.bind(this), this.redo = this.redo.bind(this)
    };
    ...
    return a.prototype = Object.create(BaseComponent3D.prototype), a.prototype.initialize = function() {
        var t = {title: _("Increase performances"),action: "wnp.request.changePerformances",index: 1};
...
var updateRenderer = function() {
    ...
    return n.prototype = Object.create(BaseComponent2D.prototype), n.prototype.initialize = function() {
        ga("send", "pageview", {dimension1: wanaplan.api.apiKey,dimension2: wanaplan.mode});
        for (var i in e)
            !function(e, i) {
                ...
                n.prototype[o] = function(e) {
                    ...
                    ga("send", "event", {eventCategory: n,eventAction: o,eventLabel: r,eventValue: s,hitCallback: function() {
    ...
    return t.prototype.setOptions = function(t) {
        ...
        if (t) {
            ...
            var n = [{content: [{label: _("Group"),type: "checkbox",value: -1 == t.name.indexOf("group_virtual") ? !0 : !1,eventParams: {eventName: "wnp.engine3D.contextMenu.group"}}]}];
            wnp.UI.ContextMenu.show({menuName: "FurnitureEditorForGroup",title: _("Group info"),width: 450,maxHeight: 200,height: 200,autoSize: !1}, n, e, !1, {furniture: t})
        }
    ...
    return t.prototype = new BaseComponent2D, t.prototype.addVirtualPoint = function(t, e) {
        ...
        t.lineWidth = 2, t.strokeStyle = "#897364";
...
var FloorComponent3D = function() {
    ...
    }, e.prototype.onContextChanged = function() {
    }, e.prototype.initialize = function() {
...
var WallComponent2D = function() {
    var t = function(t) {
        BaseComponent2D.call(this, t, "WallComponent2D"), this.TYPE_NORMAL = 1, this.TYPE_SEPARATOR = 2, this._COLORS = ["#333333", "#897364", "#BEBEBE", "#EEEEEE"], this._PATTERNS = [null, null, null, null], this._PATTERN_IMGS = [new Image, new Image, null, null], this._PATTERN_IMGS[0].addEventListener("load", function() {
    ...
    return t.prototype = new BaseComponent2D, t.WALL_OFFSET = 10, t.prototype.startListening = function() {
        ...
        this.startListening();
        var t = {title: _("房间和墙"),id: "rooms_walls",items: [{title: _("厚墙"),action: "wnp.engine2d.onAddWall",cancelAction: "wnp.engine2d.onAddWallEnd",params: {wallType: this.TYPE_NORMAL,thickness: 30,putPoint: !1}}, {title: _("隔板"),action: "wnp.engine2d.onAddWall",cancelAction: "wnp.engine2d.onAddWallEnd",params: {wallType: this.TYPE_NORMAL,thickness: 7,putPoint: !1}}, {title: _("房间分割线(无实体)"),cancelAction: "wnp.engine2d.onAddWallEnd",action: "wnp.engine2d.onAddWall",params: {wallType: this.TYPE_SEPARATOR,thickness: .2,putPoint: !1}}]};
        ...
        if ("curved" == i.instance) {
            ...
            wanaplan.engine2D.symbols2D.drawSegment(t, r, s)
                ...
                if (null != this._tmpWall) {
                    this._tmpWall.getLength() > 5 && (this._tmpWall.computeCp && this._tmpWall.computeCp(!0), this._tmpWall.computeDefault(0), this._tmpWall.computeDefault(1), this._drawWall(t, e, n, this._tmpWall, {styleId: 1}), this.displayMesure && wanaplan.getComponentByName("MeasureComponent").drawTmpWallMesure(t, e, n));
    ...
    return e.prototype.draw = function(t) {
        ...
        var e = wanaplan.getComponentByName("RoomComponent2D").getInternalRooms(), i = wanaplan.getComponentByName("RoomComponent2D").getExternalRooms(), o = wanaplan.getComponentByName("MeasureComponent"), r = o.getInternalMeasures(), s = (o.getExternalMeasures(), t.getElements("walls")), a = wanaplan.getComponentByName("FloorComponent3D").getFloor(t), l = new BABYLON.Mesh("WallMesh_" + t.id, wanaplan.engine3D.scene), h = [], c = [], u = [], p = [], d = {};
        ...
        var m, g, f, y, _, v, b, w, x, C = {}, M = 0, D = 0, B = 1;
        l.boundingBoxes = [];
        var A, E = [], T = new BABYLON.Vector3, S = new BABYLON.Vector3, L = function(t, e, n, i, o, r) {
            var r = r || 0;
            ...
            for (var e, n, i = 0, o = t.length; o > i; i++) {
                ...
                var r = new BABYLON.Vector3(-v / 2, 0, 0).add(x), s = new BABYLON.Vector3(v / 2, m.height, 0).add(x);
                _ = new BABYLON.BoundingBox(new BABYLON.Vector3(Math.min(r.x, s.x), Math.min(r.y, s.y), Math.min(r.z, s.z)), new BABYLON.Vector3(Math.max(r.x, s.x), Math.max(r.y, s.y), Math.max(r.z, s.z))), _.angle = b, C[B] = {indexStart: 3 * M,indexCount: 6,objectInstance: t[i],boundingBox: _}, B++, D += 4, M += 2, "undefined" == typeof d[m.id] && (d[m.id] = []), d[m.id].push([t[i].points[0], t[i].points[1]])
            }
        }.bind(this), P = wanaplan.structure.version;
        ...
        C[0] = {indexStart: 3 * M,indexCount: 0};
...
var OvertureComponent2D = function() {
    ...
    return t.prototype = new BaseComponent2D, t.prototype.startListening = function() {
        ...
        var t, e = [["doors", _("开放式门"), "Overture", 0, 90, 204, 0, !1, !1], ["doors", _("一般的门"), "Door", 0, 73, 204, 1, !1, !1], ["doors", _("双开门"), "Door", 0, 140, 204, 2, !1, !1], ["doors", _("滑门"), "Door", 0, 140, 204, 2, !0, !1], ["doors", _("车库门"), "Garage", 0, 240, 200, 3, !1, !1], ["bay_windows", _("固定式凸窗"), "Window", 0, 80, 215, 1, !0, !1], ["bay_windows", _("法式门"), "Window", 0, 80, 215, 1, !1, !1], ["bay_windows", _("双开法式门"), "Window", 0, 120, 215, 2, !1, !1], ["bay_windows", _("滑式凸窗"), "Window", 0, 160, 215, 2, !0, !1], ["windows", _("开放式窗"), "Overture", 90, 80, 125, 0, !1, !1], ["windows", _("固定式窗"), "Window", 90, 60, 125, 1, !0, !1], ["windows", _("单个窗"), "Window", 90, 80, 125, 1, !1, !1], ["windows", _("双开窗"), "Window", 90, 100, 125, 2, !1, !1], ["windows", _("滑窗"), "Window", 90, 100, 125, 2, !0, !1]];
        t = {title: _("门"),id: "doors",items: []}, ujs.notify("wnp.menu.main.add", {item: t,menuPath: "draw2D",position: 1}), t = {title: _("凸窗"),id: "bay_windows",items: []}, ujs.notify("wnp.menu.main.add", {item: t,menuPath: "draw2D",position: 2}), t = {title: _("窗"),id: "windows",items: []}, ujs.notify("wnp.menu.main.add", {item: t,menuPath: "draw2D",position: 3});
        for (var n in e)
            t = {title: e[n][1],action: "wnp.engine2d.onAddOverture",cancelAction: "wnp.engine2d.onAddOvertureEnd",params: {overtureType: e[n][2],elevation: e[n][3],width: e[n][4],height: e[n][5],nbCasement: e[n][6],sliding: e[n][7],galandage: e[n][8]}}, "Door" === e[n][2] && (t.params.stretched_texture = !0), ujs.notify("wnp.menu.main.add", {item: t,menuPath: "draw2D." + e[n][0],position: n})
    }, t.prototype.getTargeted = function(t) {
...
var HopperComponent3D = function() {
    ...
    return t.prototype = Object.create(BaseComponent2D.prototype), t.prototype.initialize = function() {
        ...
        wanaplan.getComponentByName("TopMenuComponent") && wanaplan.getComponentByName("TopMenuComponent").menu.json.length && (this._removeMenu(), setTimeout(function() {
                                                                                                                                                               ujs.notify("wnp.menu.top.add", {item: {id: "2D-options",title: _("2D options"),action: "wnp.request.2Doptions",index: 2},menuPath: "toolbarOption"})
                                                                                                                                                               }, 0))
...
var DecorationComponent3D = function() {
    ...
    return o.prototype = new BaseComponent3D, o.prototype.initializeLastColor = function() {
        ...
        var t = this, e = "http://v2.wanaplan.fr/data/menu.content.compiled.json";
    ...
    var e = [{title: "Grid (default)",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "0",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground01.jpg",id: "0"}}, {title: "Macadam",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "1",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground02.jpg",id: "1"}}, {title: "Soil",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "2",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground03.jpg",id: "2"}}, {title: "Grass",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "3",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground04.jpg",id: "3"}}, {title: "Grass 2",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "4",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground05.jpg",id: "4"}}, {title: "Grass 3",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "5",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground06.jpg"}}, {title: "Grass 4",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "6",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground07.jpg"}}, {title: "Grass 5",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "7",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground08.jpg"}}, {title: "Grass 6",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "8",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground09.jpg"}}, {title: "Soil",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "9",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground10.jpg"}}, {title: "Gray gravel",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "10",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground11.jpg"}}, {title: "Brick",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "11",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground12.jpg"}}, {title: "Brick 2",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "12",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground13.jpg"}}, {title: "Brick 3",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "13",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground14.jpg"}}, {title: "Brick 4",texture: !0,icon: "",action: "wnp.engine3D.changeGround",id: "14",items: [],params: {materialType: "wnp.MattMaterial",url: "http://v2.wanaplan.fr/textures/textureset/ground/ground15.jpg"}}], n = [{title: "Default sky",texture: !0,icon: "",action: "wnp.engine3D.changeSky",id: "0",items: [],params: {materialType: "lambert",url: "http://v2.wanaplan.fr/textures/textureset/sky/sky01.jpg"}}, {title: "Sky 1",texture: !0,icon: "",action: "wnp.engine3D.changeSky",id: "1",items: [],params: {materialType: "lambert",url: "http://v2.wanaplan.fr/textures/textureset/sky/sky02.jpg"}}, {title: "Sky 2",texture: !0,icon: "",action: "wnp.engine3D.changeSky",id: "2",items: [],params: {materialType: "lambert",url: "http://v2.wanaplan.fr/textures/textureset/sky/sky03.jpg"}}, {title: "Sky 3",texture: !0,icon: "",action: "wnp.engine3D.changeSky",id: "3",items: [],params: {materialType: "lambert",url: "http://v2.wanaplan.fr/textures/textureset/sky/sky04.jpg"}}];
    return t
    ...
    return r.prototype = new BaseComponent3D, r.prototype.initialize = function() {
        wnp.Constants.PRODUCTS_CATEGORY_FILE && ujs.ajax({url: wnp.Constants.PRODUCTS_CATEGORY_FILE,method: "GET",params: ""].join(""),success: function(t) {
                                                         try {
...
//            e.removeTouchSupport(), n && n.removeTouchSupport();
    ...
    var t = "http://v2.wanaplan.fr/js/Components/LockComponent/Assets/", e = function(t) {
...
}(), EditMeasureComponent = function() {
    var t = function(t) {
        BaseComponent2D.call(this, t, "EditMeasureComponent")
    };
    return t.prototype = new BaseComponent2D, t.prototype.initialize = function() {
    }, t.prototype.startListening = function() {
        ...
        var o = this.getSideToMove(n, i), r = t.points, s = r[1].subtract(r[0]), a = this.getSideToMove(Math.atan2(s.y, s.x), i), l = t.parent, h = l.getWallVector();
        displacevector = 0 == o ? h.normalize().scale(e).negate() : h.normalize().scale(e);
        var c = l.getPoints(o), u = !1;
            ...
            for (var p, d = 150, m = 0; m < l.attachedPoints.length; m++)
                if (attachedPoint = l.attachedPoints[m], p = r[a].distanceTo(attachedPoint.position), d > p)
                    for (var g = 0; g < attachedPoint.parents.length; g++) {
                        var f = attachedPoint.parents[g].getPoints(), y = f[(f.indexOf(attachedPoint) + 1) % 2].position.subtract(attachedPoint.position);
        ...
        if (null != e) {
            ...
            n = new photonui.Window({name: "Dialog_measure",title: _("Settings"),x: t.pageX,y: t.pageY,visible: !0,padding: 10});
            var i = new photonui.GridLayout, o = e.points[e.points.length - 1].subtract(e.points[0]).length(), r = new photonui.NumericField({name: "num_length",value: Math.round(o)}), s = new photonui.Label({text: _("Length") + " (cm) :",forInput: r});
            i.addChild(s, {gridX: 0,gridY: 0}), i.addChild(r, {gridX: 1,gridY: 0,gridWidth: 2});
            var a, l, h = e.parent.getWallVector().normalize(), c = Math.atan2(h.y, h.x);
            c <= Math.PI / 4 && c >= -Math.PI / 4 || c >= .75 * Math.PI || c <= -3 / 4 * Math.PI ? (a = new photonui.Button({name: "btn-left",text: _("Left")}), l = new photonui.Button({name: "btn-right",text: _("Right")})) : (a = new photonui.Button({name: "btn-left",text: _("Top")}), l = new photonui.Button({name: "btn-right",text: _("Bottom")}));
            var u = new photonui.Label({text: _("Apply to") + " :"});
            i.addChild(u, {gridX: 0,gridY: 1}), i.addChild(a, {gridX: 1,gridY: 1}), i.addChild(l, {gridX: 2,gridY: 1}), n.child = i, photonui.getWidget("btn-left").registerCallback("clickleft", "click", function() {
    ...
    return t.prototype = new BaseComponent3D, t.prototype.initialize = function() {
        ...
        var t = 500, e = API.getComponent("CameraComponent");
        if (e.cameraActiveId == e.ORBITCAMERA) {
            var n = e.camera[e.cameraActiveId].position, i = API.getComponent("AvatarComponent3D"), o = i.avatar.position;
...
!function() {
    ...
    function e() {
        ...
        var e = wnpLocalStorage.getItem("wnp.core.force2D"), n = "",
//        s = document.location.href.split("#");
    ...
    function i(t) {
        var e = t.params.env || "";
        ujs.ajax({method: "get",url: l.Constants.WNP_URL + "/data/api/" + t.apiKey + e + ".json",success: function(t) {
                 var e = JSON.parse(t);
                 if ("ok" == e.status)
    ...
    var l = window.wnp || {}, h = l.Constants.VERSION;
    window.WNP_DEBUG && (h += Math.round(100 * Math.random()));
    var c = new I18njs("./l10n/"), u = navigator.language || navigator.browserLanguage || "fr_FR", p = wnpLocalStorage.getItem(l.Constants.LC_LANG_KEY);
    if (null !== p)
        u = p;
    else {
        var d = u.split("-");
...
}(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-43771230-1", "wanaplan.fr");
