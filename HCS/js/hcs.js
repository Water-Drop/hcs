BABYLON.Engine.ShadersRepository = "http://v2.wanaplan.fr/js/Vendors/Babylon/Shaders/"
...
try {
    ...
    function e() {
        ...
        var p = function(t) {
            ...
            d = p(n); // Ω´n◊∞ªª≥…map£®≤Œ ˝Œ™key£¨÷µŒ™value£¨¿˝»Á{width=1277, height=146...}£©
        if (!GlobalHelper.hasWebGL() && e && (d.allow3D = !1),
            ...
            wanaplan.initialize(); // wanaplan = new l.Core(h, c, d) == new wnp.Core(h, c, d) “Ú¥Àwanaplan  «wnp.Coreµƒ∫Ø ˝∂‘œÛ
    }
    ...
    t(u, h), window.onload = function() {
        ...
        if (t.checkBrowserCapability()) { // ºÏ≤È‰Ø¿¿∆˜ºÊ»›–‘
            if (!GlobalHelper.isMobileDevice() && "Windows" == BrowserDetect.OS)
            // …Ë÷√—”≥Ÿº”‘ÿ∫Ø ˝
                var n = setTimeout(function() {
                // ”… setTimeout() ∑µªÿµƒ ID ÷µ-n°£∏√÷µ±Í ∂“™»°œ˚µƒ—”≥Ÿ÷¥––¥˙¬ÎøÈ°£
                // µ±wanaplan.isFullyInitializedŒ™true ±£¨Ã¯◊™÷¡http://v2.wanaplan./js/Components/PedagoComponent/pedago/pages/grapics.php
